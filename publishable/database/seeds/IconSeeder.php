...
class IconSeeder extends Seeder
{
    ...
    public function run()
    {
        $this->command->info("Icons seeding...");
        ...
        foreach ($arr as $elem) {
            if (!icon($key = $elem['type'] . '.' . $elem['icon'])) {
                $this->command->line("Adding icon with key '<info>$key</info>'...");
                Icon::create($elem);
            }
        }
    }
